...
export default function SignupForm({ onClose }: SignupFormProps) {
  ...
  return (
    <Card className="w-full max-w-md border-white/5 bg-black/40 backdrop-blur-2xl shadow-[0_0_50px_rgba(0,0,0,0.8)] rounded-2xl relative overflow-hidden group/signup">
      {/* Dynamic Glow Effect */}
      <div className="absolute -top-[30%] -left-[30%] w-[60%] h-[60%] bg-blue-500/10 rounded-full blur-[100px] pointer-events-none group-hover/signup:bg-blue-500/15 transition-all duration-700" />
      <div className="absolute -bottom-[30%] -right-[30%] w-[60%] h-[60%] bg-indigo-500/10 rounded-full blur-[100px] pointer-events-none group-hover/signup:bg-indigo-500/15 transition-all duration-700" />
      ...
      <CardHeader className="space-y-2 relative z-10 pt-8 px-8">
        <div className="flex justify-center mb-2">
          <div className="size-12 rounded-2xl bg-blue-600/10 border border-blue-500/20 flex items-center justify-center shadow-[0_0_20px_rgba(37,99,235,0.15)]">
      ...
      <CardContent className="relative z-10 px-8 pb-8 pt-4">
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <Button
            ...
            variant="premiumBlue"
            size="lg"
            className="w-full justify-center rounded-md! relative overflow-hidden group/btn mt-2"
            disabled={isPending}
          >
            {isPending ? (
